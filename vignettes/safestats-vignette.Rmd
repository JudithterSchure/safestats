...
Instead, the target is to bound the type I error by a tolerable \( \alpha \), say, \( \alpha = 0.05 \). In other words, of all ineffective drugs, at most 5 out of the 100 drugs are allowed to pass the safe test. 
